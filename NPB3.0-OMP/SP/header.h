...
c      double precision cv(0:problem_size-1),   rhon(0:problem_size-1),
c     >                 rhos(0:problem_size-1), rhoq(0:problem_size-1),
c     >                 cuf(0:problem_size-1),  q(0:problem_size-1),
c     >                 ue(0:problem_size-1,5), buf(0:problem_size-1,5)
c      common /work_1d/ cv, rhon, rhos, rhoq, cuf, q, ue, buf

c      double precision lhs(5,0:IMAX),lhsp(5,0:IMAX),lhsm(5,0:IMAX)
c      common /work_lhs/ lhs, lhsp, lhsm
