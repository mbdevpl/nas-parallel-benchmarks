...
!-------------------------------------------------------------------------!
!                                                                         !
!    This benchmark is an HPF version of the NPB BT code.                 !
!                                                                         !
...
c---------------------------------------------------------------------
       ...
       integer i, niter, step, fstatus, n3, nprocs
...
c       print*,'RHS nest time', timer_read(49)
...
c
     ...
     >  grid_points(2), grid_points(3), niter, nprocs,
