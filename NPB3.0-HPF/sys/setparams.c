...
void write_cg_info(FILE *fp, char class) 
{
  ...
  if      (class == 'S') { rowmaxnz = 127;}
  else if (class == 'W') { rowmaxnz = 168;}
  else if (class == 'A') { rowmaxnz = 294;}
  else if (class == 'B') { rowmaxnz = 404;}
  else if (class == 'C') { rowmaxnz = 525;}
  ...
  fprintf( fp, "%sinteger rowmaxnz\n", FINDENT);
  fprintf( fp, "%sparameter (rowmaxnz=%d)\n", FINDENT, rowmaxnz);
